...
process.nextTick(function() {
  var b, changed, g, h, hbox, hsv, r, s, v, vbox, window;
  gtk.init();
  r = new gtk.Entry;
  g = new gtk.Entry;
  b = new gtk.Entry;
  ...
  changed = function() {
    var currentHsv, currentRgb, _ref;
    ...
    currentRgb = (_ref = gtk.Hsv).hsvToRgb.apply(_ref, currentHsv);
    r.setText(Math.floor(currentRgb[0] * 255));
    g.setText(Math.floor(currentRgb[1] * 255));
    return b.setText(Math.floor(currentRgb[2] * 255));
  };
  hsv.on('move', changed);
